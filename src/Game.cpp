...
void Game::inicializa(int t, int v)
{
	...
	//Negras
	blancas.agregar(new Rook({ 1,8 }, 0, t));
	blancas.agregar(new Rook({ 10,8 }, 0, t));
	blancas.agregar(new Knight({ 2,8 }, 0, t));
	blancas.agregar(new Knight({ 9,8 }, 0, t));
	blancas.agregar(new Archbishop({ 3,8 }, 0, t));
	blancas.agregar(new Chancellor({ 8,8 }, 0, t));
	blancas.agregar(new Bishop({ 4,8 }, 0, t));
	blancas.agregar(new Bishop({ 7,8 }, 0, t));
	blancas.agregar(new Queen({ 5,8 }, 0, t));
	blancas.agregar(new King({ 6,8 }, 0, t));
